...
fit = FixedIterationTrainerMod(sa, IterNum, recStep, outFile)
fit.train()
print "SA: " + str(ef.value(sa.getOptimal()))

print "GA Start"
ga = StandardGeneticAlgorithm(200, 150, 25, gap)
fit = FixedIterationTrainerMod(ga, IterNum, recStep, outFile)
fit.train()
print "GA: " + str(ef.value(ga.getOptimal()))

print "MIMIC Start"
mimic = MIMIC(200, 100, pop)
fit = FixedIterationTrainerMod(mimic, IterNum, recStep, outFile)
fit.train()
